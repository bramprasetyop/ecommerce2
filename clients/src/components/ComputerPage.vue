<template>
  <div>
    <div id="rowbody" class="row">
      ...
      <div v-if="result.category === 'computer'" v-for="result in results" :key="result" id="body1" class="col s6 m3 l3">
        ...
        <div class="card">
          ...
          <div class="card-content">
            ...
            <button @click="buyItem(result)" class="btn" type="submit" name="action">Buy
